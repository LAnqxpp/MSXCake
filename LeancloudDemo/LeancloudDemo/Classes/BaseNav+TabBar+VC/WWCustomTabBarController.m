...
#import "MSXMainViewController.h"//主页
#import "MSXStoryViewController.h"//蛋糕的故事
#import "MSXTaskStatusViewController.h"//状态跟进
#import "MSXProductionViewController.h"//发布
#import "MSXMyViewController.h"//我的
...
{
    [self setupController:[[MSXMainViewController alloc]init] image:@"shouye-hui" selectedImage:@"shouye-lan" title:@"首页"];
    
    [self setupController:[[MSXTaskStatusViewController alloc]init] image:@"yongchebaogao-hui" selectedImage:@"yongchebaogao-lan" title:@"进度"];
    
    [self setupController:[[MSXProductionViewController alloc]init] image:@"" selectedImage:@"" title:@""];
    
    [self setupController:[[MSXStoryViewController alloc]init] image:@"quanzi-hui" selectedImage:@"quanzi-lan" title:@"圈子"];
    
    [self setupController:[[MSXMyViewController alloc]init] image:@"wode-hui" selectedImage:@"wode-lan" title:@"我的"];
...
- (BOOL)tabBarController:(UITabBarController *)tabBarController shouldSelectViewController:(UIViewController *)viewController
{
    ...
    if ([nowVc isKindOfClass:[MSXMainViewController class]]) {
    ...
    if ([nowVc isKindOfClass:[MSXStoryViewController class]]) {
    ...
    if ([nowVc isKindOfClass:[MSXTaskStatusViewController class]]) {
    ...
    if ([nowVc isKindOfClass:[MSXMyViewController class]]) {
...
- (void)removeTabBarButtonRotationAnimationWithCurrentViewController:(UIViewController *)currentViewController{
    ...
    //移除后重新更换选中和未选中的图片
    if ([currentViewController isKindOfClass:[MSXStoryViewController class]]) {
    ...
    //移除后重新更换选中和未选中的图片
    if ([currentViewController isKindOfClass:[MSXMainViewController class]]) {
    ...
    //移除后重新更换选中和未选中的图片
    if ([currentViewController isKindOfClass:[MSXMyViewController class]]) {
    ...
    //移除后重新更换选中和未选中的图片
    if ([currentViewController isKindOfClass:[MSXTaskStatusViewController class]]) {
